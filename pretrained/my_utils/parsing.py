...
def add_train_args(parser):
    ...
    # training params
    group.add_argument("--enable_amp", help="Whether to enable mixed precision training", action="store_true",default=True)
    ...
    #####################################################################
    group.add_argument("--margin",help="used for MolR loss",type=float,default=4.0)
    #####################################################################
    # debug params
